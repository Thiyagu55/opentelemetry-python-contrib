...
from opentelemetry.instrumentation.sqlcommenter import url_quote
from opentelemetry.instrumentation.sqlcommenter.psycopg2.extension import CommenterCursorFactory
...
class Tests(Psycopg2TestCase):
    ...
    def test_both_opentelemetry_and_opencensus_warn(self):
        with mock.patch(
            "opentelemetry.instrumentation.sqlcommenter.psycopg2.extension.logger"
...
class FlaskTests(Psycopg2TestCase):
    ...
    @mock.patch('opentelemetry.instrumentation.sqlcommenter.psycopg2.extension.get_flask_info', return_value=flask_info)
