...
from opentelemetry.instrumentation.sqlcommenter.django.middleware import SqlCommenter, QueryWrapper
...
class Tests(TestCase):
    ...
    @modify_settings(MIDDLEWARE={
        ...
        'append': 'opentelemetry.instrumentation.sqlcommenter.django.middleware.SqlCommenter',
    })
    ...
    def test_both_opentelemetry_and_opencensus_warn(self):
        with mock.patch(
            "opentelemetry.instrumentation.sqlcommenter.django.middleware.logger"
